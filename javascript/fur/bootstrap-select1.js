!function($) {
    ...
    Selectpicker.prototype = {
        ...
        createDropdown: function() {
            var drop =
                "<div class='btn-group select gray_border'>" +                    
                    "<button class='btn select_wht select_wht_bdr dropdown-toggle clearfix' data-toggle='dropdown'>" +
                        "<span class='filter-option pull-left'></span>&nbsp;" +
                        "<span class='caret'></span>" +
                    "</button>" +
                    "<span class='dropdown-arrow'></span>" +
                    "<ul class='dropdown-menu drop_color' role='menu'>" +
                    "</ul>" +
                "</div>";
